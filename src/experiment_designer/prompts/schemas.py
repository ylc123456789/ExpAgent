            ...
            "parameters": {
                ...
                "properties": {
                    ...
                    "recommended_actions": {"type": "array", "items": _SCIENTIFIC_ACTION_SCHEMA,
                        "description": "Future work after this decision, typed by capability. Do not repeat work already performed by the current advisory call."},
                    "supersedes_action_ids": {"type": "array", "items": {"type": "string", "minLength": 1},
                        "description": "Prior logical action_ids explicitly replaced by this decision. Empty means append-only."},
                ...
                "required": ["summary", "confidence", "conclusion_status", "conclusion_rationale", "evidence", "recommended_actions", "supersedes_action_ids", "risks"],
            },
        },
    },
]
